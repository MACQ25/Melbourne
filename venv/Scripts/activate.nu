...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\BackUps\ProgrammingAndDesign\IntelligentSystems\FAQbot\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\BackUps\ProgrammingAndDesign\IntelligentSystems\FAQbot\venv\Scripts\deactivate.nu'
